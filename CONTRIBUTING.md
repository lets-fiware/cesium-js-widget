# Contributing to Cesium.js widget

Thanks for checking out the Cesium.js widget Project. We're excited to hear and learn from you. We've put together the
...
-   If you open a pull request, you must sign the
    [Individual Contributor License Agreement](https://github.com/lets-fiware/cesium-js-widget/blob/master/cesium-js-widget-individual-cla.pdf) by
...
If you'd like to contribute, start by searching through the [issues](https://github.com/lets-fiware/cesium-js-widget/issues) and
[pull requests](https://github.com/lets-fiware/cesium-js-widget/pulls) to see whether someone else has raised a similar idea or
question.
...
[Issues](https://github.com/lets-fiware/cesium-js-widget/issues) and [Pull Requests](https://github.com/lets-fiware/cesium-js-widget/pulls)
